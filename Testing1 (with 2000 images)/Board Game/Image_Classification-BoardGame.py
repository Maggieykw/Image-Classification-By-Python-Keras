...
def train_network_sample():
    get_ipython().run_line_magic('run', 'train_network.py --dataset images --model BoardGame_Not_BoardGame.model')
...
#train_network("board game","not board game","images","BoardGame")
...
def main():
    ...
    modelName = "BoardGame_Not_BoardGame.model" #Inside working directory
...
test_network("board game","not board game","BoardGame_Not_BoardGame.model","Picture1.jpg")
